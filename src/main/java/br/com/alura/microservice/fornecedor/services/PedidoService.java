...
import br.com.alura.microservice.fornecedor.dtos.ItemDoPedidoDTO;
import br.com.alura.microservice.fornecedor.models.Pedido;
import br.com.alura.microservice.fornecedor.models.PedidoItem;
import br.com.alura.microservice.fornecedor.models.PedidoStatus;
import br.com.alura.microservice.fornecedor.models.Produto;
import br.com.alura.microservice.fornecedor.repositories.PedidoRepository;
...
public class PedidoService {
        ...
        private List<PedidoItem> toPedidoItem(List<ItemDoPedidoDTO> itens) {
                ...
                List<Integer> idsProdutos = itens
                                .stream()
                                .map(item -> item.getId())
